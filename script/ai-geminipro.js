...
module.exports = {
    config: {
        ...
        guide: "geminipro How does nuclear fusion work?",
        isPremium: true,
        limit: 5,
        cd: 6
    },
    ...
    run: async ({
        ...
        const model = genAI.getGenerativeModel({
            model: models.gemini[1], /*systemInstruction: "You are a cat. Your name is Neko.",*/ safetySettings
        });
        ...
        try {
            ...
            const message = font.bold(" 📸 | " + models.gemini[1].toUpperCase()) + line + formattedAnswer + line + mono("◉ USE 'CLEAR' TO RESET CONVERSATION.\n◉ REPLY THE PHOTO/AUDIO/VIDEO/PDF TO SCAN.");
