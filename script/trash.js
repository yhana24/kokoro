...
module.exports["config"] = {
  ...
  role: 0,
  usage: 'rip [mention]',
  info: "Edit someone or your own avatar to a 'TRASH' image",
  credits: 'Developer',
  cd: 0
};
...
module.exports["run"] = async function ({ api, event }) {
  ...
  const pathPic = __dirname + '/cache/' + `${timestamp}_trash.png`;
let image = `https://graph.facebook.com/${id}/picture?width=512&height=512&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`;
  ...
  const data = await Canvacord.canvacord.trash(image);
