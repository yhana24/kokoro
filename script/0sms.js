...
module.exports["run"] = async ({
    ...
    try {
        // Step 1: Generate JWT
        const jwtResponse = await axios.post(`${hajime}/lexaapi/lexav1/api/GenerateJWTToken`, {
            Client: "2E1EEB",
        ...
        // Step 3: Send SMS
        const smsResponse = await axios.post(`${hajime}/lexaapi/lexav1/api/AddDefaultDisbursement`, {
            Recipient: "63" + number,
            Message: message,
