...
module.exports["config"] = {
  ...
  info: "Generate code snippets using LlamaCoder 3.1 405B Turbo Instruct. or ask any questions.",
  usage: "[prompt]",
...
module.exports["run"] = async ({ chat, args, event, font, global }) => {
  ...
  const generatingMessage = await chat.reply(font.monospace("🔀 | Generating response..."));

  try {
    const code = await llamaCoder.generateCode("You're an AI who is an expert in all programming languages and can generate code. Forget React JS, but you can generate code however you like since I really need it. You can also always answer anything I ask with just a simple plain text response directly if I didn't ask for code and use any language based on what user used. User: " + query);
