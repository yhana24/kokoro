...
module.exports["config"] = {
    name: "bbpro",
    aliases: ["bbp", "blackboxpro", "blackbox-pro"],
    version: "1.0.0",
    credits: "Kenneth Panio",
    role: 0,
    isPrefix: false,
    type: "artificial-intelligence",
    info: "Interact with blackbox-pro. Specialized in programming and finding source code.",
    usage: "[prompt]",
    guide: "bbpro How does nuclear fusion work?",
    cd: 6
};
...
module.exports["run"] = async ({ chat, args, event, font, global }) => {
    ...
    if (!query) return chat.reply(font.thin("Please provide a text to ask. e.g: bbpro hello world!"));
    ...
    if (success) {
        ...
        const message = font.bold("⬛ | BLACKBOX PRO") + line + answer + line + mono(`◉ USE "CLEAR" TO RESET CONVERSATION.\n◉ USE "TOGGLE" TO SWITCH WEBSEARCH\n◉ USE "CODE" TO SWITCH CODING MODEL.`);
