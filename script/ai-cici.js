...
module.exports = {
    config: {
        ...
        info: "Interact with Cici AI.",
        usage: "[prompt or reply to a photo, audio, or video]",
        guide: "cici How does nuclear fusion work?",
        isPremium: true,
        limit: 5,
        cd: 6
    },
    ...
    run: async ({
        ...
        try {
            ...
            const message = font.bold("🤖 | CICI ASSISTANT".toUpperCase()) + line + formattedAnswer + line + mono("◉ USE 'CLEAR' TO RESET CONVERSATION.\n◉ REPLY THE PHOTO/AUDIO/VIDEO/PDF TO SCAN.");
