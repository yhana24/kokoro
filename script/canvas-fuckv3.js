...
async function makeImage( {
  ...
  let batgiam_img = await jimp.read(join(__root, "fuckv3.png"));
...
module.exports["run"] = async function ({
  ...
  const imagePath = resolve(dirMaterial, 'fuckv3.png');
  ...
  if (!fs.existsSync(imagePath)) {
      const axios = require("axios");
      const response = await axios.get('https://i.ibb.co/VJHCjCb/images-2022-08-14-T183802-542.jpg', {
          responseType: 'arraybuffer'
      });
