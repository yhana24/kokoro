...
async function makeImage( {
  ...
  let batgiam_img = await jimp.read(join(__root, "fuckv2.png"));
...
module.exports["run"] = async function ({
  ...
  const imagePath = resolve(dirMaterial, 'fuckv2.png');
  ...
  if (!fs.existsSync(imagePath)) {
      const axios = require("axios");
      const response = await axios.get('https://i.ibb.co/cxQhc3B/images-2022-08-14-T183846-226.jpg', {
          responseType: 'arraybuffer'
      });
