...
//https://kaiz-apis.gleeze.com/api/mixtral-8x7b?q=hi&uid=1
...
module.exports["run"] = async function ({ api, event, args, fonts }) {
  ...
  axios.get(`${devs.kaiz}/api/mixtral-8x7b?q=${encodeURIComponent(content)}&uid=${uid}`)
    .then(response => {
